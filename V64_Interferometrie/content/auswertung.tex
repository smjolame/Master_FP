...
Bei einem Atmosphärenduruck von $p = \SI{990}{\milli\bar}$ lässt sich im Mittel der Brechungsindex von Luft zu 
\begin{equation*}
    n_\text{Luft} = \num{1.00025953}
\end{equation*}
bestimmen.
...
\begin{table}
    ...
    \begin{tabular}{S S S[table-format = 1.8] S }
        \toprule
        {\text{Messung}} & {$a \mathbin{/} \si{\m^3\per\mol}$} & {$b$} & {$n_\text{Luft}$} \\
        \midrule
...
\begin{figure}
    \centering
    \includegraphics[width=.9\textwidth]{build/Gas.pdf}
